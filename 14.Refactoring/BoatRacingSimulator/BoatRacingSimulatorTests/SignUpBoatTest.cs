namespace BoatRacingSimulatorTests
{
    ...
    public class SignUpBoat
    {
        ...
        private Mock<BoatSimulatorDatabase> FakeDb { get; set; }
        ...
        public void Initialize()
        {
            ...
            var boat2 = new Yacht("Yacht1", 10, 10,engine);

            this.FakeBoats = new List<IBoat>() { boat1, boat2 };

            Mock<BoatSimulatorDatabase> fakeDb = new Mock<BoatSimulatorDatabase>();
